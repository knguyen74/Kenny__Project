...
public class MatchingGameActivity extends BaseActivity implements View.OnTouchListener{
                        ...
                        public void onClickListener() {
                            mHandler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Intent intent = new Intent(MatchingGameActivity.this,LeaderboardActivity.class);
